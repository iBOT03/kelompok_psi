...
<head>
  ...
  <title>User Panel : Cafe Rooster</title>
  ...
  <div class="wrapper">
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <div class="user-panel mt-3 pb-3 d-flex">
        <div class="image">
          <!-- <img src="<?= base_url('./uploads/foto/') .$user['foto'] ?>" style="width: 40px; height: 40px;" class="img-circle elevation-2" alt="User Image"> -->
        </div>
        <div class="info">
          <p class="d-block"><?= $this->session->userdata('nama'); ?></p>
        </div>
      </div>
        ...
        <div class="dropdown" style="float:right;">
          ...
          <div class="dropdown-content">
            <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#logoutModaluser">
