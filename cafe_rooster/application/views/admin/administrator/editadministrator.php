                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <p>Email</p>
                            <div class="input-group">
                                <input name="email" id="email" type="text" class="form-control border-dark small mb-3" placeholder="Masukkan Email" aria-describedby="basic-addon2" maxlength="100" value="<?php echo $bagian[0]->email; ?>">
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="input-group">
                                <select class="form-control border-dark small mb-3" id="posisi" name="posisi">
                                    ...
                                    <?php foreach ($row as $aaa) { ?>
                                        <option value="<?php echo $aaa['id_bagian']; ?>" <?php echo ($data[0]->id_bagian == $aaa['id_bagian'] ? 'selected' : '') ?>>
                                            <?= $aaa['bagian'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                <input name="no_telpon" id="no_telpon" type="text" class="form-control border-dark small mb-3" placeholder="Masukkan No Telepon/Whatsapp" aria-describedby="basic-addon2" onkeypress="return hanyaAngka(event)" value="<?php echo $bagian[0]->no_telepon_karyawan; ?>">
                            </div>
                    ...
                    <p>Alamat</p>
                    <div class="input-group">
                        <textarea name="alamat" id="alamat" type="text" class="form-control border-dark small mb-3" placeholder="Masukkan Alamat" aria-describedby="basic-addon2"><?php echo $bagian[0]->alamat_karyawan; ?></textarea>
                    </div>
                    ...
                    <button type="submit" href="<?php echo site_url('admin/administrator') ?>" class="btn btn-info btn-icon-split">
                        ...
                        <span class="text">Edit Administrator</span>
                    </button>
