                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-header">
                              <a href="Lap_Catering/print" class="btn btn-sm btn-info btn-icon-split shadow-sm" ">
                                      ...
                                      <?php $no = 1;
                                        foreach ($report as $row) : ?>
                                          <tr style="text-align: center;">
                                              ...
                                              <td><?= $row->id_catering; ?></td>
                                              <td><?= $row->tgl_catering; ?></td>
                                              <td><?= $row->tgl_diperlukan; ?></td>
                                              <td><?= $row->nama_menu; ?></td>
                                              <td><?= $row->jumlah_catering; ?></td>
                                              <td><?= $row->total_harga_catering; ?></td>
                                              <td>Rp. <?= number_format($row->total_catering); ?></td>
                                              <td>
                                                  <a href="#" class="badge id btn btn-warning">
