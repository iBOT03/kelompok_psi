...
<div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <!-- Page Heading -->
        <form method="post" action="<?= site_url('admin/kategorimenu/tambah') ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group">
                                <input name="namakategori" id="namakategori" type="text" class="form-control border-dark small mb-3" placeholder="Masukkan Nama Menu" aria-describedby="basic-addon2" value="<?= set_value('namakategori'); ?>">
                            </div>
