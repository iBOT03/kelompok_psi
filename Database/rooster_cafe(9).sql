...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Des 2020 pada 17.42
...
(2, 4, 2, '0000-00-00', 'Idris', '1', 0, 200000, 100000),
(3, 4, 1, '0000-00-00', '', '', 0, 0, 0);
...
--
ALTER TABLE `detail_pesan`
  MODIFY `id_detail_pesan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
