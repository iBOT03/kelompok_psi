...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 15, 2020 at 05:46 PM
...
CREATE TABLE `karyawan` (
  ...
  `status` int(2) NOT NULL COMMENT '1. Aktif; 2. Non-Aktif'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(4, 1, 'hendra01@gmail.com', '$2y$10$sK/eA7laaEOPSkDsXd186O9uDzh/Ps825hjcyLdPg9u8.Snq4DYNq', 'Hendra Prayetno', 'Paiton, Probolinggooo', '08234567891', 'foto_sayyid.jpg', 1),
...
(9, 1, 'admin@gmail.com', '$2y$10$vijCgnz7KkruMPs1o058LelPKgIlcoZ9Hnv22d7uEE49N.N3v4ELO', 'Andrea Santana A', 'Sumenep, Jawa Timur.', '085257423236', '1605354946.jpeg', 1);
...
(2, 'qqq@gmail.com', '$2y$10', 'aaa', 'asdasd', '08234567891', '1605355017.png', 2);
